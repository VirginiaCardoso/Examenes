		...
		<?php
			...
			{ 
				...
				foreach ($docentes['list'] as $indice => $docente): 
					...
					{
						echo '<option value="'.$docente['lu_alu'].'" selected = "selected">'.$docente['lu_alu'].' - '.$docente['apellido_alu'].', '.$docente['nom_alu'].'</option>';
					}
					else
					{
						echo '<option value="'.$docente['lu_alu'].'">'.$docente['lu_alu'].' - '.$docente['apellido_alu'].', '.$docente['nom_alu'].'</option>';
					}
