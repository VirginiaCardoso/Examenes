...
<script type="text/javascript" charset="utf8" src="<?php echo base_url('assets/js/dataTables.bootstrap.js'); ?>"></script>
 ...
 <div class="div-titulo">
		...
		<label><?php echo '<a href="lista_estudiantes" title="Ir la página anterior">Estudiante/</a>';?>Nuevo Estudiante</label>
 </div>
  <!-- Contenio pestaña crear nuevos usuarios  -->
  	<div id="div-form-nuevo" class="form-container">


				<form id="form-nuevou" class="form-evaluar" role="form" method="post" action="<?php echo site_url('estudiantes/set_alumno');?>">
