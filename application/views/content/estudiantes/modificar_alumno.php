...
<script type="text/javascript"  src="<?php echo base_url('assets/js/catedras/lista_catedras.js'); ?>"></script>
 ...
 <div class="div-titulo">
		...
		<label><?php echo '<a href="../lista_estudiantes" title="Ir la página anterior">Estudiantes/</a>';?>Modificar Estudiante</label>
 </div>
  <!-- Contenido pestaña crear nueva catedra  -->
  	<div id="div-form-nuevo" class="form-container">
<?php $alu = $alumno['lu_alu']; ?>

				<form id="form-modificaru" class="form-evaluar" role="form" method="post" action="<?php echo site_url('estudiantes/actualizar/'.$alu);?>">
				...
				<div class="form-group-buttons">
					<a id="btn-cancelar" href="<?php echo site_url('estudiantes/lista_estudiantes');?>" class="btn btn-default">Cancelar</a>
