...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2015 a las 15:15:35
...
--
-- Estructura de tabla para la tabla `alumnos_2`
--
...
--
-- Volcado de datos para la tabla `alumnos_2`
--

INSERT INTO `alumnos_2` (`lu_alu`, `apellido_alu`, `nom_alu`) VALUES
...
(88730, 'Abelleira', 'Guillermina Sar'),
(98064, 'Dimate Pineda', 'Jhoiner Alexander'),
(98284, 'Mandolesi', 'Nicolas'),
(98747, 'Campos', 'Giuliana'),
(101014, 'Ivanoff', 'Micaela'),
...
(76, 7, 20018, 12121212, 12198, '2015-12-14 18:14:52', 0, '', 55.6);
...
--
-- Indices de la tabla `alumnos_2`
--
ALTER TABLE `alumnos_2`
...
--
ALTER TABLE `examenes`
  MODIFY `id_exam` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=77;
--
